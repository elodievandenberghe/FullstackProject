        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastnNme = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Cities__3214EC070A98C750", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Airports__3214EC0705DD149F", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__MealChoi__3214EC07EE4AD5C3", x => x.Id);
                    table.ForeignKey(
                        name: "FK__MealChoic__Airpo__3F115E1A",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Routes__3214EC078F424933", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Seasons__3214EC07ABFEADD9", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Seasons__Airport__2CF2ADDF",
                        column: x => x.AirportId,
                        principalTable: "Airports",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Flights__3214EC074EFE3197", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__RouteSeg__3214EC07BF839F08", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Tickets__3214EC0705CCB4DD", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Tickets__FlightI__41EDCAC5",
                        column: x => x.FlightId,
                        principalTable: "Flights",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Tickets__MealId__42E1EEFE",
                        column: x => x.MealId,
                        principalTable: "MealChoices",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteSegments_AirportId",
                table: "RouteSegments",
                column: "AirportId");
